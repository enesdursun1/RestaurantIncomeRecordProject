...
public class CategoryManager : ICategoryService
{
    ...
    {
        Category? category = await _categoryDal.GetAsync(p => p.Id == getByIdCategoryRequest.Id,enableTracking:false);
    ...
    {
        var data = await _categoryDal.GetListAsync(enableTracking: false);
