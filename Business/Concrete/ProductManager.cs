...
public class ProductManager : IProductService
{
    ...
    {
        var data = await _productDal.GetListAsync(include: p => p.Include(p => p.Category),enableTracking:false);
    ...
    {
        Product? product = await _productDal.GetAsync(p => p.Id == getByIdProductRequest.Id, include: p => p.Include(p => p.Category), enableTracking: false);
    ...
    public async Task<IList<GetListByCategoryProductResponse>> GetListByCategoryIdAsync(int categoryId)
    {
        var data = await _productDal.GetListAsync(include: p => p.Include(p => p.Category),predicate:p=>p.CategoryId==categoryId, enableTracking: false);
        IList<GetListByCategoryProductResponse> getListByCategoryProductResponse = _mapper.Map<IList<GetListByCategoryProductResponse>>(data);
        return getListByCategoryProductResponse;
